...
def main():
    ...
    with open('src/scripts/restful_api.bal', 'r') as action_obj:
        action_bbe = action_obj.readlines()

    old_text = soup.find('div', {'id':'restful-api'})
    ...
    try:
        update = commit_file('index.html', updated_file, 'update-restful-api', commit_message)[0]
